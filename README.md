...
The [0.15.1 upgrade notes](docs/migrating-to-0.15.1.md) record the dependency refresh, confirmed downstream baselines and release prerequisites. The [0.15.0 upgrade notes](docs/migrating-to-0.15.md) describe the lifted NumPy ceiling and the Optuna 5.0 move. The [0.14.0 upgrade notes](docs/migrating-to-0.14.md) describe the shared-helper release sequence and installation. The [shared-helper migration guide](docs/consolidation-migration.md) explains how downstream projects can adopt the shared APIs in one dependency upgrade.
